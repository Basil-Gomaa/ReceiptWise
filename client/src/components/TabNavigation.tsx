...
export default function TabNavigation() {
  ...
  if (isMobile) {
    return (
      <div className="fixed bottom-4 left-4 right-4 z-40 backdrop-blur-md bg-white dark:bg-black/50 shadow-lg border border-gray-200 dark:border-gray-800 rounded-full pb-safe">
        <div className="flex items-center justify-around px-4 py-3">
          ...
          <Link href="/receipts">
            <div className={`flex flex-col items-center ${isActive("/receipts") ? "text-primary font-medium" : "text-gray-600 dark:text-gray-400"}`}>
              <div className={`p-1.5 rounded-full ${isActive("/receipts") ? "bg-primary/10" : ""}`}>
          ...
          <Link href="/categories">
            <div className={`flex flex-col items-center ${isActive("/categories") ? "text-primary font-medium" : "text-gray-600 dark:text-gray-400"}`}>
              <div className={`p-1.5 rounded-full ${isActive("/categories") ? "bg-primary/10" : ""}`}>
          ...
          <Link href="/settings">
            <div className={`flex flex-col items-center ${isActive("/settings") ? "text-primary font-medium" : "text-gray-600 dark:text-gray-400"}`}>
              <div className={`p-1.5 rounded-full ${isActive("/settings") ? "bg-primary/10" : ""}`}>
  ...
  return (
    <div className="mb-8 flex justify-center sm:justify-start">
      <div className="bg-white dark:bg-gray-800 rounded-full p-1.5 flex items-center justify-between gap-1 shadow-sm border border-gray-200 dark:border-gray-700">
        <Link href="/">
          <div className={`
